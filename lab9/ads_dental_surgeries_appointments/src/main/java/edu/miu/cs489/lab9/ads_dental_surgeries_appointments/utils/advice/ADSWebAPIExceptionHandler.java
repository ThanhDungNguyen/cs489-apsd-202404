package edu.miu.cs489.lab9.ads_dental_surgeries_appointments.utils.advice;
...
public class ADSWebAPIExceptionHandler {
    ...
    public Map<String, String> handlePublisherNotFoundException(DataNotFoundException dataNotFoundException) {
