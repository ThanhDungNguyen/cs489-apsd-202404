...
public class AdsDentalSurgeriesAppointmentsApplication {
    ...
    // // Add dentists
    // var dentist1 = new Dentist(null, "Tony", "Smith", "111-111-1111",
    // "tony.smith@email.com",
    // "Specialization 1");
    // dentistService.addNewDentist(dentist1);

    // var dentist2 = new Dentist(null, "Helen", "Pearson", "111-111-2222",
    // "helen.pearson@email.com",
    // "Specialization 2");
    // dentistService.addNewDentist(dentist2);

    // var dentist3 = new Dentist(null, "Robin", "Plevin", "111-111-3333",
    // "robin.plevin@email.com",
    // "Specialization 3");
    // dentistService.addNewDentist(dentist3);

    // var dentist4 = new Dentist(null, "First1", "Last1", "111-111-4444",
    ...
    // var address10 = new Address(null, "Street 10", "City 10", "State 10",
    // "99990");
    // addressService.addNewAddress(address10);

    // var address11 = new Address(null, "Street 11", "City 11", "State 11",
    // "99900");
    // addressService.addNewAddress(address11);

    // var address12 = new Address(null, "Street 12", "City 12", "State 12",
    // "99000");
    // addressService.addNewAddress(address12);

    // var address13 = new Address(null, "Street 13", "City 13", "State 13",
    // "90000");
    // addressService.addNewAddress(address13);

    // var address14 = new Address(null, "Street 14", "City 14", "State 14",
    // "99991");
    // addressService.addNewAddress(address14);

    // // Add patients
    // var patient1 = new Patient("P100", "Gillian", "White", "222-222-1111",
    // "gillian.white@email.com",
    // LocalDate.of(1988, 1, 1), address1);
    // patientService.addNewPatient(patient1);

    // var patient2 = new Patient("P105", "Jill", "Bell", "222-222-2222",
    // "jill.bell@email.com",
    // LocalDate.of(1988, 2, 2), address2);
    // patientService.addNewPatient(patient2);

    // var patient3 = new Patient("P108", "Ian", "MacKay", "222-222-3333",
    // "ian.mackay@email.com",
    // LocalDate.of(1988, 3, 3), address3);
    // patientService.addNewPatient(patient3);

    // var patient4 = new Patient("P110", "John", "Walker", "222-222-4444",
    // "john.walker@email.com",
    // LocalDate.of(1988, 4, 4), address4);
    // patientService.addNewPatient(patient4);

    // var patient5 = new Patient("P115", "First2", "Last2", "222-222-5555",
    ...
    // // Add appointments
    // var appointment1 = new Appointment(null, LocalDateTime.of(2013, 9, 12, 10, 0,
    // 0), dentist1, patient1,
    // surgery3);
    // appointmentService.addNewAppointment(appointment1);

    // var appointment2 = new Appointment(null, LocalDateTime.of(2013, 9, 12, 12, 0,
    // 0), dentist1, patient2,
    // surgery3);
    // appointmentService.addNewAppointment(appointment2);

    // var appointment3 = new Appointment(null, LocalDateTime.of(2013, 9, 12, 10, 0,
    // 0), dentist2, patient3,
    // surgery1);
    // appointmentService.addNewAppointment(appointment3);

    // var appointment4 = new Appointment(null, LocalDateTime.of(2013, 9, 14, 14, 0,
    // 0), dentist2, patient3,
    // surgery1);
    // appointmentService.addNewAppointment(appointment4);

    // var appointment5 = new Appointment(null, LocalDateTime.of(2013, 9, 14, 16,
    // 30, 0), dentist3, patient2,
    // surgery3);
    // appointmentService.addNewAppointment(appointment5);

    // var appointment6 = new Appointment(null, LocalDateTime.of(2013, 9, 15, 18, 0,
    // 0), dentist3, patient4,
    // surgery2);
    ...
    // System.out.println(String.format("Updated appointment: %s",
    // updatedAppointment));
